...
export default function BusinessWebsiteCard({
  shop,
  compact = false,
}: {
  shop: Shop;
  /** Hides the big "Live Website Preview" iframe section — for places
   * like the Home tab overview where the card must stay small, not eat
   * the whole screen the way the full Promotions-tab version does. */
  compact?: boolean;
}) {
