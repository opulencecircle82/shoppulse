    ...
    <section id="about" className="bg-brand-slate py-24">
      <div className="mx-auto max-w-5xl px-6 lg:px-8">
        ...
        <div className="mt-16 grid gap-6 sm:grid-cols-2">
          ...
          <div className="rounded-2xl border border-brand-emerald/20 bg-brand-slate-light/40 p-8">
            <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-brand-emerald/15 text-brand-emerald">
