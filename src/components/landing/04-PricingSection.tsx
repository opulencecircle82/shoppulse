  ...
  return (
    <section id="pricing" className="bg-brand-slate py-24">
      <div className="mx-auto max-w-5xl px-6 lg:px-8">
        ...
        <div className="mt-10 mx-auto max-w-md rounded-2xl border border-brand-blue/40 bg-brand-slate-light/50 p-8 shadow-[0_0_40px_rgba(37,99,235,0.15)]">
          <span className="rounded-full bg-brand-blue/15 px-3 py-1 text-xs font-semibold text-brand-blue">
            Free Forever
          </span>
          <p className="mt-4 text-4xl font-bold text-slate-900">
            {symbol}0<span className="text-lg font-medium text-slate-500">/mo</span>
          </p>
        ...
        <div className="mt-12">
          ...
          <div className="mt-6 grid gap-6 sm:grid-cols-3">
            {ADD_ONS.map((addon) => (
              ...
              >
                <h3 className="text-sm font-semibold text-slate-900">{addon.name}</h3>
